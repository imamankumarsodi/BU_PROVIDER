//
//  ServiceHistoryVC+UITableView.swift
//  BU_PROVIDER
//
...
extension ServiceHistoryVC:UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: ServiceHistoryTableViewCell.className, for: indexPath) as? ServiceHistoryTableViewCell else {
...
extension ServiceHistoryVC:UITableViewDelegate{
