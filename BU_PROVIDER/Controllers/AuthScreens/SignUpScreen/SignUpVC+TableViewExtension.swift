...
extension SignUpVC:UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.showPasswordCallBack = {
            cell.textFieldFloating.isSecureTextEntry = !cell.textFieldFloating.isSecureTextEntry
            let image = cell.textFieldFloating.isSecureTextEntry ? UIImage(systemName: "eye.slash.fill") : UIImage(systemName: "eye.fill")
            cell.btnEyeRef.setImage(image, for: .normal)
        }
