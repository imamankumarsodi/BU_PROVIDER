...
struct Api_keys_model {
    ...
    public static let type_provider_id      =       "type_provider_id"
    public static let type_name             =       "type_name"
    public static let idproof               =       "idproof"
    public static let type_id               =       "type_id"

    public static let idproof_no            =       "idproof_no"
    public static let Idproof_picture       =       "idproof_picture"
    
    public static let parent_name           =       "parent_name"
    public static let address_provider_id   =       "address_provider_id"
    ...
    public static let bank_provider_id      =       "bank_provider_id"
    public static let bank_holder_name      =       "bank_holder_name"
    public static let bank_account_number   =       "bank_account_number"
    public static let bank_ifsc_code        =       "bank_ifsc_code"
